...
- **Full effects chain** - 14-type multimode filter, comb resonator, ring mod, lo-fi (bit/sample rate), compressor, beat repeat, pitch shift, stereo delay, 3-band EQ, plate reverb (Plaits is inserted after main voice VCA and is not affected by filter, resonator, ring mod, or lof)
