...
impl App {
    pub fn new(metro_tx: Sender<MetroCommand>, metro_state: Arc<Mutex<MetroState>>, theme: Theme, config: &crate::config::Config) -> Self {
        Self {
            ...
            scope_timespan_ms: config.display.scope_timespan_ms,
            scope_color_mode: config.display.scope_color_mode,
            scope_display_mode: config.display.scope_display_mode,
            scope_unipolar: config.display.scope_unipolar,
