    ...
    F: FnMut(String),
{
    ...
    match cmd {
        ...
        "RM" | "RESO.MIX" => Some(synth_params::handle_rm(parts, variables, patterns, counters, scripts, script_index, metro_tx, debug_level, scale, out_cfm, output).map(|_| vec![])),
        ...
        "DW" | "DLY.WET" => Some(synth_params::handle_dw(parts, variables, patterns, counters, scripts, script_index, metro_tx, debug_level, scale, out_cfm, output).map(|_| vec![])),
        ...
        "RW" | "REV.WET" => Some(synth_params::handle_rw(parts, variables, patterns, counters, scripts, script_index, metro_tx, debug_level, scale, out_cfm, output).map(|_| vec![])),
        ...
        "LM" | "LOFI.MIX" => Some(synth_params::handle_lm(parts, variables, patterns, counters, scripts, script_index, metro_tx, debug_level, scale, out_cfm, output).map(|_| vec![])),
        ...
        "RGM" | "RING.MIX" => Some(synth_params::handle_rgm(parts, variables, patterns, counters, scripts, script_index, metro_tx, debug_level, scale, out_cfm, output).map(|_| vec![])),
        ...
        "CR.MIX" | "COMP.MIX" => Some(synth_params::handle_cr_mix(parts, variables, patterns, counters, scripts, script_index, metro_tx, debug_level, scale, out_cfm, output).map(|_| vec![])),
        ...
        "BR.MIX" | "BRX" => Some(synth_params::handle_br_mix(parts, variables, patterns, counters, scripts, script_index, metro_tx, debug_level, scale, out_cfm, output).map(|_| vec![])),
        ...
        "PS.MIX" | "PSX" => Some(synth_params::handle_ps_mix(parts, variables, patterns, counters, scripts, script_index, metro_tx, debug_level, scale, out_cfm, output).map(|_| vec![])),
        ...
        "CL.WET" | "CLW" => Some(synth_params::handle_cl_wet(parts, variables, patterns, counters, scripts, script_index, metro_tx, debug_level, scale, out_cfm, output).map(|_| vec![])),
