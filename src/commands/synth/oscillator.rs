...
define_mode_param!(handle_pw, "pw", 0, 2, "PW", "WAVEFORM MUST BE 0 (SIN), 1 (TRI), OR 2 (SAW)", "PRIMARY WAVEFORM", "Failed to parse waveform value");
define_float_param!(handle_mf, "mf", 20.0, 20000.0, "MF", "MOD FREQUENCY", "Failed to parse frequency value", "HZ");
define_mode_param!(handle_mw, "mw", 0, 3, "MW", "WAVEFORM MUST BE 0 (SIN), 1 (TRI), 2 (SAW), OR 3 (FEEDBACK)", "MOD WAVEFORM", "Failed to parse waveform value");
