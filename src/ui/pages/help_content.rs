...
pub const HELP_CATEGORIES: &[HelpCategory] = &[
    ...
    HelpCategory {
        ...
        lines: &[
            ...
            "  PENV.ATK/DEC/CRV/MODE/GATE/AMT - PITCH ENVELOPE",
            "  FMEV.ATK/DEC/CRV/MODE/GATE/AMT - FM ENVELOPE",
            "  DENV.ATK/DEC/CRV/MODE/GATE/AMT - DISCONTINUITY ENV",
            "  FBEV.ATK/DEC/CRV/MODE/GATE/AMT - FEEDBACK ENV",
            "  FLEV.ATK/DEC/CRV/MODE/GATE/AMT - FILTER ENV",
            "",
            "# ENVELOPE AMOUNTS (DEPTH)",
            "  PENV.AMT / PA <0-16>    PITCH ENV OCTAVES",
            "  FMEV.AMT / FA <0-16383> FM ENV AMOUNT",
            "  DENV.AMT / DA <0-16383> DISCONTINUITY AMT",
            "  FBEV.AMT / FBA <0-16383> FEEDBACK AMT",
