...
pub const HELP_CATEGORIES: &[HelpCategory] = &[
    HelpCategory {
        ...
        lines: &[
            ...
            "  FLASH <MS>         ACTIVITY FLASH HOLD TIME (DEFAULT 200)",
            "  RST                RESET TO DEFAULTS",
            "  LOAD.RST           SHOW RESET MODE (0=PERSIST, 1=RESET)",
            "  LOAD.RST <0|1>     SET SCENE LOAD BEHAVIOR",
    ...
    HelpCategory {
        ...
        lines: &[
            ...
            "    X           TRIGGER (RETURNS 1)",
            "    _ OR .      REST (RETURNS 0)",
            "    ?           RANDOM TRIGGER (50% 1, 50% 0)",
            "    NUMBERS     100, -12, 0",
            "    NOTES       C3, E3, F#4, Bb2 (SEMITONES)",
            "  MODIFIERS:",
            "    *N          REPEAT N TIMES (C3*4 = C3 C3 C3 C3)",
            "    <A B>       TOGGLE/CYCLE (DETERMINISTIC, LIKE TOG)",
            "    {A B}       RANDOM CHOICE (UNPREDICTABLE, LIKE EITH)",
    ...
    HelpCategory {
        ...
        lines: &[
            ...
            "  MIDI.DIAG <0|1>  ENABLE/DISABLE TIMING DIAG",
            "  MIDI.DIAG REPORT WRITE REPORT TO FILE",
            "  SC.DIAG <0|1>    ENABLE/DISABLE SC TIMING DIAG",
            "  SC.DIAG REPORT   WRITE SC REPORT TO FILE",
    ...
    HelpCategory {
        ...
        lines: &[
            ...
            "  HL.SEQ <0|1>     SEQ/TOG HILI",
            "  HL.COND <0|1>     COND HILITE",
            "  CPU <0|1>         CPU METER",
            "  HEADER <0-4>      HDR VERBOSE",
            "  TITLE <0|1>       MONO/SCENE",
            "  DEBUG <0-2>       DEBUG LVL",
            "",
        ],
    },
